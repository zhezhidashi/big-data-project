def generate_sql_script():
    ...
    for i in range(20):
        ...
        for j in range(30):
            # 构建表名
            table_name = f"result_test01_{i:02}_{j:02}"
            # 生成 SQL 查询语句
    ...
    for i in range(20):
        ...
        for j in range(30):
            ...
            table_name = f"result_test01_{group_num}_{table_num}"
            ...
            create_table_query += f"LOCATION 's3a://zhaozihao-us-east-2/alluxio/aitop-test01/{table_name}';\n\n"

            sql_script += create_table_query

    with open("delete-create-result-tables-test01.sql", "w") as file:
