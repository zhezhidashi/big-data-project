    ...
    for i in range(len(thread_counts)):
        ...
        while end_index < len(sql_files):
            ...
            for sql_file in selected_sql_files:
                ...
                for i in range(30):
                    for j in range(50):
                        script += "cp /mnt/fuse/aitop-test05/result_test05_" + sql_file[8:10] + "_{:02d}/* /root/zzh/aitop-test/test-result_".format(i) + sql_file[8:10] + "_{:02d}_{:02d}.csv\n".format(i, j)
...
output_dirs = ["test05/thread-01", "test05/thread-02", "test05/thread-05", "test05/thread-10", "test05/thread-20"]
